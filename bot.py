...
# Supported coins (you can add more later)
COINS = {
...
# ---------- NowPayments ----------
def create_payment(amount_usd: float, pay_currency: str, order_id: str):
...
async def receive_coin(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    try:
        payment = create_payment(amount, coin_code, order_id)
